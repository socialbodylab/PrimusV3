...
# is new on radius-central; do not let a main/V5 merge drop or renumber it back
# into 0x82xx (the historical collision that forced the remap). Enforced by
# tests/test_artnet_opcodes.py; full table in V4/FIRMWARE_DEVELOPMENT.md.
