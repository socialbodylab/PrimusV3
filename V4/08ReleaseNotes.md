...
- **V1 firmware 3.8.0** — ReceiveMode (split/combined universes), ArtReceiveConfig `0x8110`, discovery tokens `U:S:N` / `U:C:N`, PrimusCentral/Device Manager receive-mode UI, V3 TFT receive screen.
