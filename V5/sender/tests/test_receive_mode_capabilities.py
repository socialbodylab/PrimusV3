...
class ArtReceiveConfigPacketTests(unittest.TestCase):
    ...
    def test_build_split_packet_rejects_base_32767(self):
        with self.assertRaisesRegex(ValueError, "0-32766"):
            build_receive_config_packet("split", 32767)

    def test_build_combined_packet_allows_base_32767(self):
        pkt = build_receive_config_packet("combined", 32767)
        self.assertEqual(struct.unpack("<H", pkt[13:15])[0], 32767)
