/*
 * config.h — PrimusV3.5 Receiver Configuration
 * ==================================================
...
//  Firmware Info
// =====================================================================
#define FIRMWARE_NAME    "PrimusV3.5"
...
// Maximum pixels on any single output. Sized for the V3.5 extra-long strip.
...
// NVS namespace for V3.5 receiver config.
