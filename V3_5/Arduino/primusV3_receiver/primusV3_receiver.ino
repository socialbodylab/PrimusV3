/*
 * primusV3_receiver.ino — PrimusV3.5 Art-Net LED Receiver
 * =============================================================
 ...
 *
 * Build profiles are selected by V3_5/Arduino/upload.sh.
 */
...
void setup() {
  ...
  Serial.println("Direct NeoPixel outputs OK — brightness locked to 255");
#endif
